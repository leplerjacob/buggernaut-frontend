...
class ProjectCommentsMiniComponent extends React.Component {
  renderStat(title, value) {
    return (
      <Row flexGrow={1} horizontal="space-between" vertical="center">
        ...
        <span className={(css(styles.itemTitle), styles.itemValue)}>
          {value}
        </span>
      </Row>
    );
...
export default ProjectCommentsMiniComponent;
